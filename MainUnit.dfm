object TSPatcher: TTSPatcher
  ...
  Caption = 'Windows XP (x86) Terminal Services Realtime by StalkerSTS'
  ClientHeight = 300
  ClientWidth = 406
  Color = clBtnFace
  ...
  object Log: TMemo
    ...
    Font.Style = []
    Lines.Strings = (
      'Terminal Services Realtime Patch by StalkerSTS'
      'Copyright '#169' StalkerSTS 2016'
      'http://stascorp.com - Stas'#39'M'
